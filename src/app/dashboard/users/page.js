                  ...
                  <div className="overflow-hidden">
                    <table id="myTable" className="min-w-full">
                      <thead>
                        <tr className="">
                          <th scope="col"
                            className="text-base bg-gray-100 border-b border-gray-200 dark:border-gray-900 dark:bg-background items-center flex font-medium text-gray-700 dark:text-gray-100 px-6 py-3 text-left">
                            <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" className="mr-4" />
                            <label for="vehicle1" className="block"> Name </label>
                          </th>
                          <th scope="col"
                            className="text-base bg-gray-100 border-b border-gray-200 dark:border-gray-900 whitespace-nowrap dark:bg-background font-medium text-gray-700 dark:text-gray-100 px-6 py-3 text-left">
                            Package Name </th>
                          <th scope="col"
                            className="text-base bg-gray-100 border-b border-gray-200 dark:border-gray-900 whitespace-nowrap dark:bg-background font-medium text-gray-700 dark:text-gray-100 px-6 py-3 text-left">
                          ...
                          <th scope="col"
                            ...
                            Package End Date </th>
                          <th scope="col"
                            className="text-base bg-gray-100 border-b border-gray-200 dark:border-gray-900 whitespace-nowrap dark:bg-background font-medium text-gray-700 dark:text-gray-100 px-6 pb-0 text-left">
                            Paid Amount </th>
                          <th scope="col"
                            className="text-base bg-gray-100 border-b border-gray-200 dark:border-gray-900 whitespace-nowrap dark:bg-background font-medium text-gray-700 dark:text-gray-100 px-6 text-left">
                            Action </th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className="align-middle hover:bg-gray-50 dark:hover:bg-background">
                          <td
                            className="border-b border-gray-200 dark:border-gray-900 whitespace-nowrap text-sm font-medium text-gray-700 dark:text-gray-300 px-6 py-3">
                            <div className="flex items-center mr-10">
                              <input type="checkbox" id="vehicle2" name="vehicle1" value="Bike" className="mr-4" />
                              <label for="vehicle2" className="flex items-center"><img
                                className="w-9 h-9 object-cover rounded-full mr-4 border border-white"
