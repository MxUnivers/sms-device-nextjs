...
export default function HeaderAdmin() {
    ...
    return (
        <div className="dashboard-header transition-all duration-200 fixed lg:left-64 left-0 z-30 shadow-front-2 bg-white h-20 lg:w-[calc(100%-256px)] w-full px-7 py-4 flex flex-col justify-center  top-0">
                ...
                <div className="flex items-center">
                    <div className="relative mr-3">
                        ...
                        >
                            ...
                            <span className="lg:block hidden font-bold text-gray-700">Mon Compte</span>
                        ...
                        {/* Dropdown menu */}
                        {dropdownOpen && (
                            <div className="dropdown-menu bg-white  text-gray-700 absolute right-0 w-48 mt-2 rounded-md shadow-lg z-10">
                                <div className="dropdown-links max-w-xs py-3">
                                    <a className="link hover:text-blue-500 px-4 py-1 flex items-center text-sm text-gray-700 ">Profile </a>
                                    <a className="link hover:text-blue-500 px-4 py-1 flex items-center text-sm text-gray-700 ">Paramètre</a>
                                    <button onClick={toggleModal} className="link hover:text-red-500 px-4 py-1 flex items-center text-sm text-gray-700 ">
